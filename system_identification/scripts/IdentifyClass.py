...
class Identify():
    ...
    '''
    def __init__(self):
        self.type = 1                     # 0: linear step, 1: angular step
        ...
        self.robot_vel_sub = rospy.Subscriber('/tb3_0/odom', Odometry, \
                                                self.step, queue_size=1)
        self.speed_pub = rospy.Publisher('/tb3_0/cmd_vel', Twist, queue_size=1)
    ...
    def step(self, msg):
        ...
        if self.type == 0:
            ...
            self.angular_vel_data.append(msg.twist.twist.angular.z)
