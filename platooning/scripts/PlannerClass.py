...
class Planner(PID, Waypoint):
    ...
    def __init__(self):
        ...
        self.longitudinal_ref = 0.3         # Used as reference to create longitudinal error
        self.local_speed = []               # Stores current speed of robot as [linear, angular]
        self.deceleration_constant = 0.02   # Deceleration constant used to simulate stop with inertia
        ...
        if self.running_flag:
            ...
            if len(self.local_pose) != 0:
                ...
                if len(self.waypoint_list) > 0:
                    ...
                    # Calculate longitudinal control#[0]#[0]
    ...
    def stop(self, type):
        ...
        # Start the platoon again after stopping with ITS-G5.
        if type == 0:
            self.running_flag = True

        """Comment self.running_flag above and uncomment the stuff below
           to be able to stop the turtlebots imidiately"""
