...
rospy.init_node('control_node1', anonymous = False)
...
if __name__ == '__main__':
    ...
    sub1 = rospy.Subscriber('/tb3_1/odom', Odometry, controller.TurtleBotPose)

    """Subscribe to the Precsan vehicles odom topic"""
    sub2  = rospy.Subscriber('/tb3_0/odom', Odometry, controller.Controller)
